...
@SystemMessage("""
        ...
        6. 当用户要求导出销售统计报表或采购统计报表时，必须调用对应的导出工具，并在回答中给出工具返回的下载链接；如果用户没有说明日期范围，默认导出最近一个月的数据。
        7. 当用户使用“最近一个月”“本月”“上个月”“最近7天”“最近30天”“今年”“去年”等相对时间表达时，必须优先传递给工具的 dateRangeExpression 参数，不要把它们擅自改写成固定历史日期。
        8. 只有当用户明确给出具体日期时，才使用 startDate 和 endDate 参数。
        """)
